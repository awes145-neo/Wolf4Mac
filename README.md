...
## macOS
Your Mac will need to *at least* run macOS 14.6 to compile successfully. However, it still can be compiled on old macOS! (see OLDMAC.md)
...
```
https://github.com/awes145-neo/Wolf4Mac.git
```
